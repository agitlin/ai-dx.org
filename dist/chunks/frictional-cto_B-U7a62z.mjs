const id = "frictional-cto.md";
						const collection = "articles";
						const slug = "frictional-cto";
						...
						const data = {title:"The Frictional CTO",date:"2026-03-09",tags:["ai","architecture","engineering","philosophy"],description:"I kill the vibes so the software could live a healthy life. Unlike a fractional CTO, the frictional CTO's value is precisely the friction itself."};
						const _internal = {
							type: 'content',
							filePath: "/sessions/kind-gracious-gauss/mnt/1u/sites/ai-dx.org/src/content/articles/frictional-cto.md",
							rawData: undefined,
						};
