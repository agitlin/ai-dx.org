const id = "the-mile-metaphor.md";
						const collection = "articles";
						const slug = "the-mile-metaphor";
						...
						const data = {title:"The Mile Metaphor",date:"2026-02-04",tags:["ai","philosophy","metaphor","dx"],description:"I think the main goal of AI is to help us maintain stealth while we keep adding mileage between us and our problems."};
						const _internal = {
							type: 'content',
							filePath: "/sessions/kind-gracious-gauss/mnt/1u/sites/ai-dx.org/src/content/articles/the-mile-metaphor.md",
							rawData: undefined,
						};
